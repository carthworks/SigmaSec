...
OPENGREP_BINARY = _env("OPENGREP_BINARY", "opengrep")
OPENGREP_RULESET = _env("OPENGREP_RULESET", "p/default")
OPENGROUP_BINARY = _env("OPENGROUP_BINARY", OPENGREP_BINARY)
OPENGROUP_RULESET = _env("OPENGROUP_RULESET", OPENGREP_RULESET)
...
OPENGROUP_TIMEOUT = int(_env("OPENGROUP_TIMEOUT", str(OPENGREP_TIMEOUT)))
